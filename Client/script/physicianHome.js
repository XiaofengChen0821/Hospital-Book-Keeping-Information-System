...
function populateDropdowns() {
    var physicianName = localStorage.getItem('name');

    // AJAX request to the server to get patients of a physician
    $.ajax({
        url: 'http://localhost:8080/HBKIS/GetPatientsOfPhysician',
        type: 'GET',
